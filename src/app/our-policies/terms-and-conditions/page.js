        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div className="px-6 py-8 sm:px-8 sm:py-10 text-gray-800 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mt-2 [&_ul]:mb-3 [&_li]:mb-1 [&_a]:text-indigo-700 [&_a]:underline [&_a:hover]:opacity-80">
            ...
            <section className="mb-8">
              ...
              <p className="mb-3">Welcome to Bridge to Brilliance, an educational initiative of AD Life Trust ("AD Life Trust", "we", "us", "our"). By accessing our website <a href="https://www.adlifetrust.org.in" target="_blank" rel="noopener noreferrer">www.adlifetrust.org.in</a>, registering for any program, or using any services provided under the Bridge to Brilliance Talent and Coaching Scholarship initiative, you ("user", "student", "participant", "you") agree to be bound by these Terms of Use ("Terms").</p>
            ...
            <section className="mb-8">
              ...
              <p className="mb-3">The Bridge to Brilliance Talent and Coaching Scholarship program is an education-focused program under AD Life Trust that provides skill development, academic support, and educational opportunities to students from underserved communities.</p>
            ...
            <section className="mb-8">
              ...
              <div className="mb-4">
                ...
                <p className="mb-1">a. Upon successful registration, you will receive login credentials (if applicable). You are responsible for maintaining the confidentiality of your username and password.</p>
                <p className="mb-1">b. You must immediately report any suspected unauthorized access or breach of your account to <a href="mailto:director@adlifetrust.org.in">director@adlifetrust.org.in</a>.</p>
                <p>c. AD Life Trust shall not be liable for any loss or damage arising from your failure to maintain the security of your account credentials.</p>
              </div>

              <div className="mb-4">
                <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">3.3 Accuracy of Information</h3>
                <p>You agree to provide truthful, accurate, and current information during registration and to promptly update it if it changes. Submission of false or misleading information may result in cancellation of your enrollment without a refund.</p>
              </div>
            ...
            <section className="mb-8">
              ...
              <p className="mb-1">a. Use the Website or services for any unlawful, fraudulent, or unauthorized purpose</p>
              <p className="mb-1">b. Impersonate any person or entity, or misrepresent your affiliation with any person or organization</p>
              <p className="mb-1">c. Upload, post, or transmit any content that is defamatory, obscene, offensive, hateful, discriminatory, or otherwise objectionable</p>
              <p className="mb-1">d. Harass, threaten, bully, or intimidate other participants, volunteers, or staff</p>
              <p className="mb-1">e. Attempt to gain unauthorized access to any part of the Website, servers, or systems</p>
              <p className="mb-1">f. Damage, disable, overburden, or impair the functioning of the Website or associated services</p>
              <p className="mb-1">g. Collect or harvest personal information of other users without their consent</p>
              <p className="mb-1">h. Use automated tools, bots, or scripts to access or scrape the Website</p>
              <p className="mb-1">i. Violate any applicable local, state, national, or international law or regulation</p>
              <p className="mb-3">j. Upload or distribute viruses, malware, or any other malicious code</p>
              <p className="italic">Violation of this code of conduct may result in immediate suspension or termination of your enrollment and access to services.</p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="mb-4">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>Enrollment in the Bridge to Brilliance Talent and Coaching Scholarship program is subject to availability, eligibility criteria, and selection by AD Life Trust.</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Some Bridge to Brilliance Talent and Coaching Scholarship programs may be offered free of charge as part of our social mission; others may carry a nominal registration or course fee.</li>
            ...
            <section className="mb-8">
              ...
              <p className="mb-1">a. All content on the Website and program materials—including text, graphics, logos, videos, curriculum, assessments, and software—is the intellectual property of AD Life Trust or its licensors and is protected under applicable copyright and intellectual property laws.</p>
              <p className="mb-1">b. You may access and use the content solely for personal, non-commercial educational purposes within the Bridge to Brilliance program.</p>
              <p className="mb-1">c. You may NOT reproduce, distribute, publish, transmit, modify, display, or create derivative works from any content without the prior written permission of AD Life Trust.</p>
              <p>d. Any feedback, suggestions, or testimonials you provide to AD Life Trust may be used by us for promotional or improvement purposes without any obligation to compensate you.</p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>AD Life Trust makes no guarantee regarding employment outcomes, academic outcomes, or other results from participation in the Bridge to Brilliance Talent and Coaching Scholarship programs.</p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>This limitation applies regardless of whether such damages arise in contract, tort, negligence, or any other cause of action.</p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>Upon termination, your right to access program materials ceases immediately. Refunds, if applicable, will be governed by the Refund Policy.</p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-3">These Terms shall be governed by and construed in accordance with the laws of India. Any disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts of Hyderabad, Telangana, India.</p>
            ...
            <section className="mb-4">
              ...
              <div className="mt-2 bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <p>Phone: <a href="tel: +918019037799" className="text-indigo-700 hover:underline">+91 8019037799</a></p>
