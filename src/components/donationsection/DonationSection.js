            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-4 flex-1">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-start">
                                        <svg className="flex-shrink-0 w-5 h-5 mt-0.5 text-green-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        {/* <span className="text-green-300">Tax exemption certificate available</span> */}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-8 border border-gray-700 hover:border-purple-500 transition-all duration-300 hover:shadow-lg flex flex-col h-full">
                        ...
                        {/* Donation Button - moved inside flex container */}
