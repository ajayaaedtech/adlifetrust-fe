✅ Quick Takeaways for AD Life:

Feature	Why It Matters	Example:-
Hero Stats	Build trust with impact figures (e.g., lives transformed)	Smile, Akshaya Patra
Clear Programs	Break into Education / Health / Livelihood	AD Life already uses these categories
Stories & Testimonials	Emotional connection and credibility	Bal Raksha Bharat
Visual Impact	Use photos, icons, bold CTAs	All sites
Transparency Section	Show reports, impact, audits	Genesis Foundation
Responsive Navigation	Easy access to programmes, donate, volunteer, contact	Smile, Save the Children
Local Identity	Highlight local/regional work, partners	Sambhali Trust
      ...
      <section className="bg-gradient-to-br from-orange-600 via-orange-700 to-red-700 text-white relative overflow-hidden">
        ...
        <div className={`relative max-w-6xl mx-auto px-4 py-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-3 text-white">AD Life Trust</h1>
            <p className="text-xl text-orange-100 mb-2 italic">Adding Value to Life</p>
            <p className="text-orange-50 max-w-2xl mx-auto">
              Empowering communities and transforming lives across India since 2005
            </p>
          </div>
